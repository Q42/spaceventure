...
function startGame() {  
  ...
  $('#button-tweet').live('touchstart mousedown click', tweet);
  ...
  if ($.browser.ios) {
    ...
    $('#preloader').bind('touchmove', eatTouch);
...
function cycle() {
  ...
  if (Math.random() < 0.000042 && !dialog) {
    doActions(
...
function tweet() {  
 ...
 encodeURIComponent("I just died horribly while playing living concept art 4 by @AndromedaGuys! ")+
 encodeURIComponent("Help get the game made: http://tgakick.com #SpaceVenture");
}
