var dialogs = {
  ...
  'screen1': {
    ...
    leftsidefrondshand: "Really? PolyStyTM fern fronds? Someone here is too lazy to water a few plants? That’s just sad.",
    ...
    arcadeopened: "It appears not everything here is at is seems, which isn’t a surprise given everything in here appears to be pre-fab. Somebody’s really cheap!",
    arcadeopened2: "You briefly wonder if domes like these can be purchased though the mail before recounting a bad experience you once had with a mail order company.",

    cluckstart: "It's Cluck Y'Egger, your favorite game since you were a just little space ranger! You have failed at this game a thousand times, but you always came back for more. Here's one for old times sake...",
    cluckend1: "The GAME OVER screen confronts you with your utter inability to succeed at this game. Or any game for that matter.",
    cluckend2: "As you ponder the deeper meaning of being a failure at life, the arcade cabinet starts to rumble and spontaneously moves out of the way, revealing a cave.",
    ...
    arcadescreenhand: "Using your advanced deduction abilities, you note that the screen is a modern AXO-LED with a bioluminescent matrix and cold induction dynamo-nucloid generation activator. All this from touch!",
...
var endUrl = 'http://guysfromandromeda.com/closing-thoughts-scott-mark-prototype-4/';
