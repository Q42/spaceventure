var dialogs = {
  ...
  'screen1': {
    ...
    buckazoidlook: "It appears to be a single buckazoid. Who left that here?",
    buckazoidhand: "You lean down and procure the coin from the carpet. It's been a while, but the feel of having a real, genuine, authentic buckazoid in your hands makes you all tingly insi--- wait. Is this thing made of aluminum?",
    buckazoidhand2: "Is nothing in this place real?!",
    ...
    arcadelook: '"Cluck Y\'Egger Arcade". A small label below the screen reads "Designed by Two Guys From Andromeda, this time without enslavement."',
    arcadehand: "Feels rubbery. Is this thing real?",
    arcadeopen: 'You slide the buckazoid into the slot marked "insert coin". As you hear the coin tumble down the cabinet\'s innards, you\'re surprised to find that rather than turning itself on, the cabinet merely slides out of the way, revealing a cave. Huh.',
    arcadeopened: "It appears that not everything here is as it seems. Which probably isn't that surprising given that everything seems to have been produced in a factory.",
    arcadeopened2: "You briefly wonder if domes like these can be ordered by mail before recounting a bad experience you had once. Something about a whistle. And robots.",

    arcadejoysticklook: "It's a joystick. Have you ever wondered why it's called a 'joy stick'? Whoever came up with that had some screws loose, I'll tell ya.",
    arcadejoystickhand: "You jiggle the stick, but nothing happens.",

    arcadepadlook: "Four little pointy arrow things, which appear to be made of CruddTex™ and stuck on there with glue or something.",
    arcadepadhand: "That's some pretty effective glue. Try as you might, you can't pry those buttons off!",

    arcadescreenlook: "Looking at the screen more closely reveals that this thing isn't even turned on. In fact, it looks like the screen is actually just a plastic sheet with a stencil print on it.",
    arcadescreenhand: "It's stuck pretty firmly on there.",

    arcadeslotlook: "It's a small slot labeled 'insert coin here'. Seems like a strange place to put a slot - it almost seems like it was shoved on there as an afterthought.",
    arcadeslothand: "Haven't you played enough adventure games by now to know not to go around sticking your hands in random slots? Imagine what could happen!",
    ...
    'end7': "Turning back to you, Mark says: \"Really, why are you still standing there? Go back to the Kickstarter campaign page and help get us get to $400,000! Move along, little Earth man.\"",
...
var endUrl = 'http://guysfromandromeda.com/closing-thoughts-scott-mark-prototype-3/';
